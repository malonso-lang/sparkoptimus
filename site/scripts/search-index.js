...
(function () {
  ...
  window.SO.SEARCH_INDEX = [
    ...
    { title: "Digital Strategy & Transformation",  url: "/services/digital-strategy",         cat: "Service", desc: "Future-proof your business through digital",          kw: "digital strategy transformation technology omnichannel customer" },
    { title: "AI & Data Strategy & Transformation",url: "/services/ai-data-strategy", cat: "Service", desc: "Unlock the power of AI and data",                    kw: "AI artificial intelligence data analytics machine learning generative" },
    ...
    { title: "Mergers and Acquisitions",           url: "/services/mergers-acquisitions",      cat: "Service", desc: "Commercial due diligence and deal support",           kw: "mergers acquisitions M&A due diligence private equity deal" },
    { title: "Ventures and Scale-ups",             url: "/services/ventures",cat: "Service", desc: "Ventures and scale-up growth",                       kw: "ventures startups scale-ups growth innovation founder" },
    ...
    { title: "Industrial Goods & Services",        url: "/sectors/industrial-goods-services",cat: "Sector", desc: "B2B digital acceleration",                           kw: "industrial goods B2B manufacturing aftermarket digital services" },
    { title: "Private Equity",                     url: "/sectors/private-equity",       cat: "Sector",  desc: "Due diligence and value creation",                   kw: "private equity PE due diligence value creation portfolio fund" },
    ...
    { title: "HEMA case study",                    url: "cases/case-hema",                       cat: "Case",    desc: "Digital transformation at HEMA retail",             kw: "HEMA retail case study digital transformation results" }
  ];
})();
